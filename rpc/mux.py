...
class XMMMux(object):
    ...
    def __init__(self, path='/dev/xmm0/mux'):
        ...
        pkd = binascii.unhexlify(
            '414442480000010088000000700000006000000000383AFFFE80000000000000'
            '0000000000000001FE80000000000000D438C1FD077C00C38600248840005550'
            '000000000000000005010000000005DC03044040FFFFFFFFFFFFFFFF00000000'
            '20018004142021F5000000000000000041445448180000000000000000000000'
            '1000000060000000')
        p = MuxPacket(seq=1)
        p.append_tag(b'ADBH', binascii.unhexlify(
            '6000000000383AFFFE800000000000000000000000000001FE80000000000000'
            'D438C1FD077C00C38600248840005550000000000000000005010000000005DC'
            '03044040FFFFFFFFFFFFFFFF0000000020018004142021F50000000000000000')
        )
